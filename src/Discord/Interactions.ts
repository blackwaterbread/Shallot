...
import { getInstances, saveInstances, Instance, getConfigs } from "Config";
...
import { forcedEmbedRefresh, startRefresherEntire, stopRefresherEntire } from "Lib/Refresher";
        ...
        switch (buttonId[0]) {
            ...
            case serverDelete: {
                ...
                const target = key === 'user' ?
                    Array.from(serverInstance.instances).find(([k, v]) => v.discord.owner.id === userId) :
                    Array.from(serverInstance.instances).find(([k, v]) => k === key);
            ...
            case adminStartRcon: {
                ...
                const instance = serverInstance.instances.get(instanceId);
            ...
            case adminRconDelete: {
                ...
                if (instance) {
                    ...
                    serverInstance.instances.set(key, newInstance);
                    saveInstances();
                    forcedEmbedRefresh();
    ...
    /* ModalSubmit Interaction */
        ...
        switch (modalId[0]) {
            ...
            case serverModify: {
                ...
                const origInstance = serverInstance.instances.get(origInstanceKey);
                ...
                if (origInstanceKey !== newInstanceKey) {
                    serverInstance.instances.delete(origInstanceKey);
                }

                serverInstance.instances.set(newInstanceKey, newInstance);
                saveInstances();
            ...
            case rconRegister: {
                ...
                serverInstance.instances.set(instanceId, newInstance);
                saveInstances();
